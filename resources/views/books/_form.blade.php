...
{!! Form::label('authors_id', 'Penulis', ['class'=>'col-md-2 control-label']) !!}
<div class="col-md-4">
<!-- {!! Form::select('authors_id', [''=>'']+App\Author::pluck('name','id')->all(), null) !!} -->
{!! Form::select('authors_id', [''=>'']+App\Author::pluck('name','id')->all(), null, ['class'=>'js-selectize','placeholder' => 'Pilih Penulis']) !!}
