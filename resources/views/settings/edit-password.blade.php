      ...
      <div class="col-md-12">
         <nav aria-label="breadcrumb primary">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('/settings/profile') }}">Profile</a></li>
         ...
         <div class="card">
               ...
               <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                  {!! Form::label('password', 'Password lama', ['class'=>'col-md-4 control-label']) !!}<div class="col-md-6">
